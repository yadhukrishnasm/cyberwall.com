...
export function FaqItem({ question, answer }: FAQEntry) {
  return (
    <details className="group py-5 md:py-6">
      <summary className="font-nunito flex cursor-pointer list-none items-center justify-between gap-4 text-base font-semibold text-neutral-950 marker:content-none md:text-lg">
        {question}
